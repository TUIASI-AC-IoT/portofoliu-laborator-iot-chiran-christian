...
#define CONFIG_EXAMPLE_FIRMWARE_UPGRADE_URL "https://192.168.245.219:5000/firmware.bin" 
#define CONFIG_VERSION_EXAMPLE_FIRMWARE_UPGRADE_URL "https://192.168.245.219:5000/version" 
...
static void ota_task(void *pvParameters)
{
    ...
    ESP_LOGI(TAG, "Starting OTA version verification");
    esp_http_client_config_t config = {
        .url = CONFIG_VERSION_EXAMPLE_FIRMWARE_UPGRADE_URL,
    ...
    ESP_LOGI(TAG, "Attempting to read the version of the app %s", config.url);
